              ...
              <div class="option-group">
                <div class="option-field">
                  ...
                  <label for="<?php echo $questions[3]["option1"] ?>">
                    <input type="radio" name="option" id="<?php echo $questions[3]["option1"] ?>" value="<?php echo $questions[3]["option1"] ?>" hidden>
                ...
                <div class="option-field">
                  ...
                  <label for="<?php echo $questions[3]["option2"] ?>">
                    <input type="radio" name="option" id="<?php echo $questions[3]["option2"] ?>" value="<?php echo $questions[3]["option2"] ?>" hidden>
              ...
              <div class="option-group">
                <div class="option-field">
                  ...
                  <label for="<?php echo $questions[3]["option3"] ?>">
                    <input type="radio" name="option" id="<?php echo $questions[3]["option3"] ?>" value="<?php echo $questions[3]["option3"] ?>" hidden>
                ...
                <div class="option-field">
                  ...
                  <label for="<?php echo $questions[3]["option4"] ?>">
                    <input type="radio" name="option" id="<?php echo $questions[3]["option4"] ?>" value="<?php echo $questions[3]["option4"] ?>" hidden>
              ...
              <div class="option-group">
                <div class="option-field">
                  ...
                  <label for="<?php echo $questions[5]["option1"] ?>">
                    <input type="radio" name="option" id="<?php echo $questions[5]["option1"] ?>" value="<?php echo $questions[5]["option1"] ?>" hidden>
                ...
                <div class="option-field">
                  ...
                  <label for="<?php echo $questions[5]["option2"] ?>">
                    <input type="radio" name="option" id="<?php echo $questions[5]["option2"] ?>" value="<?php echo $questions[5]["option2"] ?>" hidden>
              ...
              <div class="option-group">
                <div class="option-field">
                  ...
                  <label for="<?php echo $questions[5]["option3"] ?>">
                    <input type="radio" name="option" id="<?php echo $questions[5]["option3"] ?>" value="<?php echo $questions[5]["option3"] ?>" hidden>
                ...
                <div class="option-field">
                  ...
                  <label for="<?php echo $questions[5]["option4"] ?>">
                    <input type="radio" name="option" id="<?php echo $questions[5]["option4"] ?>" value="<?php echo $questions[5]["option4"] ?>" hidden>
              ...
              <div class="option-group">
                <div class="option-field">
                  ...
                  <label for="<?php echo $questions[6]["option1"] ?>">
                    <input type="radio" name="option" id="<?php echo $questions[6]["option1"] ?>" value="<?php echo $questions[6]["option1"] ?>" hidden>
                ...
                <div class="option-field">
                  ...
                  <label for="<?php echo $questions[7]["option2"] ?>">
                    <input type="radio" name="option" id="<?php echo $questions[7]["option2"] ?>" value="<?php echo $questions[7]["option2"] ?>" hidden>
              ...
              <div class="option-group">
                <div class="option-field">
                  ...
                  <label for="<?php echo $questions[7]["option3"] ?>">
                    <input type="radio" name="option" id="<?php echo $questions[7]["option3"] ?>" value="<?php echo $questions[7]["option3"] ?>" hidden>
                ...
                <div class="option-field">
                  ...
                  <label for="<?php echo $questions[7]["option4"] ?>">
                    <input type="radio" name="option" id="<?php echo $questions[7]["option4"] ?>" value="<?php echo $questions[7]["option4"] ?>" hidden>
              ...
              <div class="option-group">
                <div class="option-field">
                  ...
                  <label for="<?php echo $questions[7]["option1"] ?>">
                    <input type="radio" name="option" id="<?php echo $questions[7]["option1"] ?>" value="<?php echo $questions[7]["option1"] ?>" hidden>
              ...
              <div class="option-group">
                <div class="option-field">
                  ...
                  <label for="<?php echo $questions[8]["option1"] ?>">
                    <input type="radio" name="option" id="<?php echo $questions[8]["option1"] ?>" value="<?php echo $questions[8]["option1"] ?>" hidden>
                ...
                <div class="option-field">
                  ...
                  <label for="<?php echo $questions[8]["option2"] ?>">
                    <input type="radio" name="option" id="<?php echo $questions[8]["option2"] ?>" value="<?php echo $questions[8]["option2"] ?>" hidden>
              ...
              <div class="option-group">
                <div class="option-field">
                  ...
                  <label for="<?php echo $questions[8]["option3"] ?>">
                    <input type="radio" name="option" id="<?php echo $questions[8]["option3"] ?>" value="<?php echo $questions[8]["option3"] ?>" hidden>
                ...
                <div class="option-field">
                  ...
                  <label for="<?php echo $questions[8]["option4"] ?>">
                    <input type="radio" name="option" id="<?php echo $questions[8]["option4"] ?>" value="<?php echo $questions[8]["option4"] ?>" hidden>
              ...
              <div class="option-group">
                <div class="option-field">
                  ...
                  <label for="<?php echo $questions[9]["option1"] ?>">
                    <input type="radio" name="option" id="<?php echo $questions[9]["option1"] ?>" value="<?php echo $questions[9]["option1"] ?>" hidden>
                ...
                <div class="option-field">
                  ...
                  <label for="<?php echo $questions[9]["option2"] ?>">
                    <input type="radio" name="option" id="<?php echo $questions[9]["option2"] ?>" value="<?php echo $questions[9]["option2"] ?>" hidden>
              ...
              <div class="option-group">
                <div class="option-field">
                  ...
                  <label for="<?php echo $questions[9]["option3"] ?>">
                    <input type="radio" name="option" id="<?php echo $questions[9]["option3"] ?>" value="<?php echo $questions[9]["option3"] ?>" hidden>
                ...
                <div class="option-field">
                  ...
                  <label for="<?php echo $questions[9]["option4"] ?>">
                    <input type="radio" name="option" id="<?php echo $questions[9]["option4"] ?>" value="<?php echo $questions[9]["option4"] ?>" hidden>
